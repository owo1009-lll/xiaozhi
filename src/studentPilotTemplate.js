...
export const REAL_STUDENT_PILOT_TEMPLATES = [
  {
    ...
    studentCount: 10,
    durationDays: 5,
    goal: "验证课堂练习、智能导师、图片问答和课后作业链路在小样本真实教学中的稳定性。",
    recruitment: [
      "优先覆盖不同基础层次：优秀 3 人，中等 4 人，基础薄弱 3 人。",
      "至少包含 2 名经常使用手机完成作业的学生。",
      "至少包含 2 名对五线谱或节奏明显薄弱的学生，便于观察智能辅导效果。",
    ],
    phases: [
      { phase: "第 1 天：基线测评", tasks: "完成 1 次课堂练习、2 次智能导师提问、1 次课后作业草稿。", evidence: "记录初始掌握概率、首轮错题和导师响应时间。" },
      { phase: "第 2-4 天：连续使用", tasks: "每天 15-20 分钟，完成课前预习、课堂练习、至少 1 次智能导师问答。", evidence: "记录最困惑知识点、最好用功能和遇到的问题。" },
  ...
  },
  {
    ...
    recruitment: [
      ...
      "确保至少 5 名学生主要使用手机端完成智能导师和拍照作业。",
      "每一章至少有 2 名学生完成完整学习链路，保证章节覆盖。",
    ],
    phases: [
      { phase: "第 1-2 天：适应期", tasks: "熟悉课前预习、内容呈现、课堂练习、智能导师和课后作业入口。", evidence: "记录入口理解难点和页面切换问题。" },
      { phase: "第 3-5 天：高频使用期", tasks: "每天完成 1 次课堂练习、2 次智能导师问答、1 次作业提交。", evidence: "记录掌握度变化、图片问答成功率和作业提交质量。" },
      { phase: "第 6-7 天：总结评估", tasks: "抽查 5 名学生进行半结构化访谈，并导出全体 PDF 学习报告。", evidence: "教师比对掌握概率与实际表现是否一致。" },
    ],
    successCriteria: [
      "智能导师整体通过率 ≥ 90%",
      "并发使用时页面与接口无明显卡顿或报错",
      "掌握度模型对不同水平学生的掌握差异区分明显",
      "教师可用 PDF 学习报告完成课后复核",
    ],
    observationFields: [
      "学生姓名 / 学号 / 班级",
